      ...
      <div className="company-culture-content">
        <div className="company-culture-header">
          ...
          <p className="company-culture-main-text">
            阳光：仁爱友善（底色）、诚信正直（秉性）、积极合作（品行），阳光的人不仅自己积极乐观，更能温暖和点亮周围的人。
          </p>
          <p className="company-culture-main-text">
            保鲜：虑怀空杯（态度）、敏锐创新（行为）、追求卓越（精神），保持对新生事物的好奇心为追求卓越而不断学习和探索。
          </p>
          <p className="company-culture-main-text">
            担当：勇于挑战（勇气）、敢于担责（能力）、带头争先（凝聚力），前进的道路上总有困难和挑战，只有敢于挑战的勇士带领团队迎难而上，方可负重前行。
          </p>
          <p className="company-culture-main-text">
            靠谱：严谨求实（作风）、高效协同（过程）、善作善成（结果），伟大的事业都是一个个小小的成功铸就的，只有值得信赖的人坚持执行，才能做成靠谱的事。
          </p>
